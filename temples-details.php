    ...
    <div class="off-canvas-page">
      ...
      <div class="portray-section">
        ...
        <div class="page-sheet">
          <div class="container">
            <div class="grid-temples-details">
              <div class="grid-temples-details__title">
                <?php the_title() ?>
              </div>

              <div class="grid-temples-details__parent">
                <a class="ui-all-button" href="<?php the_permalink(get_post()->post_parent) ?>">к списку храмов</a>
              </div>

              <div class="grid-temples-details__hr">
                <div class="ui-hr"></div>
              </div>

              <div class="grid-temples-details__share">
              ...
              <?php if ($introtext): ?>
              <div class="grid-temples-details__introtext content">
                <?php echo $introtext ?>
              </div>
              <?php endif; ?>

              <?php if ($latest_query->have_posts()): ?>
              <div class="grid-temples-details__latest-title">
                <div class="section-headline section-headline_yellow">
                  <div class="section-headline__title">все новости храма</div>
                </div>
              </div>

              <div class="grid-temples-details__latest-body">
                ...
                <div class="card-aegle">
                  ...
                  <?php endif; ?>
                  <a href="<?php the_permalink($item) ?>" class="card-aegle__title">
              ...
              <div class="grid-temples-details__news">
              ...
              <div class="grid-temples-details__pagination">
                <?php wp_pagenavi(['query' => $news]) ?>
              </div>
              <?php endif; ?>

              <?php if ('' !== get_post()->post_content): ?>
              <div class="grid-temples-details__content content">
                <?php the_content() ?>
              </div>
              <?php endif; ?>
            </div>
